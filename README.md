...
>
> Security app in the DClaw Stack. Built with Next.js, FastAPI, PostgreSQL, and the DKube Design System.

[![Status](https://img.shields.io/badge/status-P4%20Planned-DC2626)](https://github.com/dclawstack/dclaw-secure)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/secure)

---

## Overview

DClaw Secure is an AI-native security application. It follows the standard DClaw architecture:
...
DClaw Secure uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-secure.git
cd dclaw-secure
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_secure"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-secure.git /opt/dclaw-secure
cd /opt/dclaw-secure
docker compose up -d
```

The app will be available at `https://secure.dclawstack.io`.

### Kubernetes

```bash
cd helm/dclaw-secure
helm dependency build
helm upgrade --install dclaw-secure . \
...
- [Docs](https://docs.dclawstack.io/apps/secure)
